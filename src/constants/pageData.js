...
export const EXPERIENCE = {
  ...
  items: [
    {
      url: 'websites-preview/titansoftlogo.png',
      websiteURL:
        'website/web develoepment/index.html', //optional open url in new tab
    },
    {
      url: 'websites-preview/service.jpg',
      websiteURL:
        'website/server/index.html',
    },
    {
      url: 'websites-preview/EightDesign.jpg',
      websiteURL:
        'website/interior website/index.html',
    },
  ],
};
...
export const SKILLS_LIST = {
  ...
  items: [
    ...
    { url: 'icons/gsap.svg', websiteURL: null },
    ...
    { url: 'icons/max.jpg', websiteURL: null },
    { url: 'icons/unity-icon.png', websiteURL: null },
